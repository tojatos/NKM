...
//		public HexCoordinates Coordinates => HexCell.Coordinates;
...
//		public Character CharacterOnCell
//		{
//			get { return !HexCell.IsFreeToStand ? HexCell.CharactersOnCell[0] : null; }
//			set {
//				if (value == null)
//				{
//					Game.HexMap.RemoveFromMap(HexCell.CharactersOnCell[0]);
//				}
//				else
//				{
//					Game.HexMap.Move(value, HexCell);
//				}
//				
//			}
//		}
...
//		{
//			get { return HexCell.Type; }
//			set { HexCell.Type = value; }
//		}
...
//		public HexDirection GetDirection(HexCell targetCell) => HexCell.GetDirection(targetCell);
//
//		public HexCell GetCell(HexDirection direction, int distance) => HexMapDrawer.Instance.Cells.First(c => c.BetterHexCell ==
//			HexCell.GetCell(Game.HexMap, direction, distance));
//
//		public List<HexCell> GetNeighbors(int depth, SearchFlags searchFlags = SearchFlags.None,
//			Predicate<HexCell> stopAt = null)
//			=> HexCell.GetNeighbors(Game.HexMap, Active.GamePlayer, depth, searchFlags, stopAt)
...
//			=> HexCell.GetLine(direction, depth)
//				.Select(c => HexMapDrawer.Instance.Cells.FirstOrDefault(g => g.BetterHexCell == c)).ToList();
//
//		public int GetDistance(HexCell cell) => HexCell.GetDistance(cell.BetterHexCell);
//		
...
//			=> HexCell.GetArea(direction, height, width)
//				.Select(c => HexMapDrawer.Instance.Cells.FirstOrDefault(g => g.BetterHexCell == c)).ToList();
